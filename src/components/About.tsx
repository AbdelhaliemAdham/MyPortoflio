  ...
  return (
    <section className="bg-[#080808] text-center" id="about">
      ...
      <p className="text-base w-[90%] md:text-xl text-start text-[#9C9C9C] md:w-[70%] mx-auto py-5 leading-relaxed">
        ...
        technologies and improve my skills. I love problem-solving and have a
        strong desire to create beautiful and functional applications. I'm open
        to new opportunities and collaborations with talented developers.
        Currently, I'm seeking a remote position as a Front-End Developer.
      </p>
    </section>
  );
}
